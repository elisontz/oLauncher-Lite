...
• Two navigation styles: vertical scrolling or horizontal paging

• Clean and familiar interface with smooth animations

• Fast search and instant app launching

• Create custom icon folders to organize app icons

• Freely rearrange app icons

• Customizable icon size for a personalized layout

• Hide unused apps

• Keyboard shortcut to quickly open the launcher

• Modern UI with fluid transitions

• Automatically adapts to system light/dark mode, with option to manually customize appearance

• Trackpad gesture support

• Optimized experience for third-party mouse users

• Supports English and Chinese (auto adapts to system language)
